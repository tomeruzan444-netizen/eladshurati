...
// The authored family-business page is here for its diagram and two-column
// table - the widest things on any page at phone width.
const PAGES = ['/', '/פיתוח-עסקי/', '/צרו-קשר/', '/רווח-תפעולי/', '/category/בלוג-עסקי-מקצועי/', '/ייעוץ-עסקי-לעסק-משפחתי/', '/שיווק-לקוסמטיקאיות/', '/שיווק-רואי-חשבון/', '/פרסום-ושיווק-לעורכי-דין/']
